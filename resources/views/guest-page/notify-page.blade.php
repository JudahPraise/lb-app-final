...
<div class="container-fluid d-flex justify-content-center align-items-center w-100" style="height: 80vh">
    <div class="card shadow border p-5 d-flex justify-content-center align-items-center">
      ...
      <h1 style="font-size: 2.5rem; font-weight: bold; font-family: 'Poppins', sans-serif;">Thank you for notifying us!</h1>
      <p>We'll sent you an email with a link for next scheduled interview. 🎉</p>
      <br>
      <p>Thank you!</p>
      <br>
      <br>
